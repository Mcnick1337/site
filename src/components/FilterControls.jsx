...
// This single constant defines the exact style from your image for all input types.
...
// Specific styles for the dropdowns to add the custom arrow
const selectStyles = `
  ${sharedInputStyles}
  appearance-none 
  bg-no-repeat 
        ...
        <div className="relative z-10 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-4 my-6 flex flex-wrap items-end gap-4">
            ...
            <div className="flex-grow min-w-[120px]">
                ...
                <DatePicker
                    ...
                    className={sharedInputStyles} // Apply the styles directly
                />
            </div>
